...
export function Item({ isSignedUp }: { isSignedUp?: boolean }){
    
    if(isSignedUp){
        return <button className="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">log out</button> 
    }
    return  <div><Link href="/login" className="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Log in</Link>
            <Link href="/signup" className="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Sign up</Link></div>
}
    ...
    return (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex-shrink-0">
                <Link href="/" className="text-white font-bold text-xl">Election System</Link>
            </div>
